module Admin
  class PostsController < AdminController
    ...
    def index
      ...
      #@posts = Post.joins(:category, :user).order("created_at DESC")
    end
    ...
    private
      ...
      def post_params
        params.require(:post).permit(:title, :body, :category_id, :user_id, :image, :remove_image,
          :publish_date_time, :published)
      end
  end
end
